...
<body class="body">
  ...
  ?>
    <div class="perf row">
      ...
      ?>
      <div class="foto col">
        <img class="imp" src="../img/<?= $_SESSION["info_logado"]["foto"]; ?>">
      </div>
      <div class="info col">
        <div class="card-body">
          <h4 class="nomeu"><?= $_SESSION["info_logado"]["nome"]; ?></p>
            <p class="nicku"><?= $_SESSION["info_logado"]["nick"]; ?></p>
            <p class="emailu"><?= $_SESSION["info_logado"]["email"]; ?></p>
    ...
    <div class="modal" id="myModal">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="../backend/alterarRenan.php" name="alter" method="POST" enctype="multipart/form-data">
            <!-- Modal body -->
            <div class="modal-body">

              <img src="../img/<?= $_SESSION["info_logado"]["foto"]; ?>" class="img-fluid" alt="Imagem do Usuário">
              ...
              <div class="form-floating">
                <input type="text" name="nome_alt" value="<?= $_SESSION["info_logado"]["nome"]; ?>" class="form-control">
                <label for="floatingText">Nome</label>
              </div>

              <div class="form-floating">
                <input type="text" name="nick_alt" value="<?= $_SESSION["info_logado"]["nick"]; ?>" class="form-control">
                <label for="floatingText">Nickname</label>
              </div>

              <div class="form-floating">
                <input type="email" class="form-control" name="email_alt" value="<?= $_SESSION["info_logado"]["email"]; ?>">
                <label for="floatingInput">Email address</label>
              </div>
              <div class="form-floating">
                <input type="text" class="form-control" name="senha_alt" value="<?= $_SESSION["info_logado"]["senha"]; ?>">
