        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                <a href="../app/index.php?home" class="navbar-brand">
                    <img src="../img/logo_temp.png" alt="logo não veio" id="logo">
                </a>
                <li class="nav-item" id="botao">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../frontend/mensagens.php">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li class="nav-item">
                    <a href="?sair" class="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-box-arrow-right" viewBox="0 0 16 16" id="incon">
                            <path fill-rule="evenodd"
